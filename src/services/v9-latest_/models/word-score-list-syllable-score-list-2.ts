 ...
 */
export const wordScoreListSyllableScoreList2 = z.lazy(() => {
  return z.object({
...
/**
 *
 * @typedef  {WordScoreListSyllableScoreList2} wordScoreListSyllableScoreList2
 * @property {number[]}
 * @property {string}
 * @property {number}
 * @property {number}
 ...
 * @property {number}
 */
export type WordScoreListSyllableScoreList2 = z.infer<typeof wordScoreListSyllableScoreList2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const wordScoreListSyllableScoreList2Response = z.lazy(() => {
  return z
    .object({
      extent: z.array(z.number()).optional(),
      letters: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const wordScoreListSyllableScoreList2Request = z.lazy(() => {
  return z
    .object({
